...
#undef ABSOLUTE
    ...
    void addNamedCallbackNode(const std::string& name, cocos2d::Node* node);
    
    void setAnimationControllerName(const std::string& name);
    /**
     * @js NA
     * @lua NA
     */
...
private:
    ...
    CCBNamedNode * _nameNode;
    
    bool _jsControlled;
    std::string _animationControllerName;
};
