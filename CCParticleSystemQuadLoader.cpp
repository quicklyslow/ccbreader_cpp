...
#define PROPERTY_RESETONVISIBILTYTOGGLE "resetOnVisibilityToggle"
...
void ParticleSystemQuadLoader::onHandlePropTypeCheck(Node * pNode, Node * pParent, const char * pPropertyName, bool pCheck, CCBReader * ccbReader){
        if(strcmp(pPropertyName, PROPERTY_RESETONVISIBILTYTOGGLE) == 0) {
            ((ParticleSystemQuad *)pNode)->resetOnVisibilityToggle(pCheck);
        } else {
